...
public class QiandaoxinxiVO  implements Serializable {
	...
	/**设置：周次*/
	public void setZhouci(String zhouci) { this.zhouci = zhouci; }
	/**获取：周次*/
	...
	/**设置：节次*/
	public void setJieci(String jieci) { this.jieci = jieci; }
	/**获取：节次*/
	public String getJieci() { return jieci; }
	/**设置：教师工号*/
	public void setJiaoshigonghao(String jiaoshigonghao) { this.jiaoshigonghao = jiaoshigonghao; }
	/**获取：教师工号*/
	public String getJiaoshigonghao() { return jiaoshigonghao; }
	/**设置：教师姓名*/
	...
	/**设置：截止时间*/
	public void setJiezhishijian(Date jiezhishijian) { this.jiezhishijian = jiezhishijian; }
	/**获取：截止时间*/
	public Date getJiezhishijian() { return jiezhishijian; }

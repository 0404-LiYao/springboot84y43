...
public class KaoqintongjiController {
    ...
    public R count(@RequestParam Map<String, Object> params,KaoqintongjiEntity ketixinxi, HttpServletRequest request){
        String tableName = request.getSession().getAttribute("tableName").toString();

        EntityWrapper<KaoqintongjiEntity> ew = new EntityWrapper<KaoqintongjiEntity>();
        int count = kaoqintongjiService.selectCount(MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, ketixinxi), params), params));
